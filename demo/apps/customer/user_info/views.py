...
from demo.apps.address.models import Province, District, City
from demo.apps.customer.safety.utils import mask_mobile, mask_mail_url
from demo.apps.customer.user_info.serializers import UserInfoSerializer
...
class UserInfoView(APIView):
    ...
    def post(self, request, *args, **kwargs):
        ...
        data['sex'] = {'male': 1, 'female': 2, 'hid': 3}.get(data.get('sex'), 1)
