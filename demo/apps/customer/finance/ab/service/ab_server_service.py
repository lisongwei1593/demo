...
from demo.apps.customer.finance.ab.log import ab_log as logging
from demo.apps.customer.finance.ab.signal import received_file_names_done
from demo.apps.customer.finance.models import AbSignInContractLog, AbRescindContractLog, AbRechargeWithdrawHistory, \
    AbRechargeWithdrawLog
from demo.apps.customer.user_info.utils import get_user_id_from_inst_account_id
...
class SignContractFromBankServerService(AbServerService):
    ...
    def check_msg_text(self, data, pack_key, pin_key, mac_key):
        ...
        if not data.get('BankAccount'):   # 银行文档虽然不是必须项，市场需要
            r['Code'] = '178887'  # 参数错误
