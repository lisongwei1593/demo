...
from demo.apps.dashboard.staticpages import forms
from demo.apps.dashboard.staticpages.models import FlatPageNew as FlatPage
...
class PageListView(ListView):
    ...
    """
    template_name = 'dashboard/staticpages/index.html'
    model = FlatPage
...
class PageCreateView(generic.CreateView):
    template_name = 'dashboard/staticpages/update.html'
    model = FlatPage
    ...
    def get_success_url(self, page):
        msg = render_to_string('dashboard/staticpages/messages/saved.html',
                               {'page': page})
        messages.success(self.request, msg, extra_tags='safe noicon')
        return reverse('dashboard:staticpage-list')
...
class PageDeleteView(generic.DeleteView):
    template_name = 'dashboard/staticpages/delete.html'
    model = FlatPage
